...
+ (instancetype)wj_grayLine
{
    return [UIColor colorWithRed:220/255.f green:220/255.f blue:220/255.f alpha:1.0];
}
+ (instancetype)wj_grayBorder
{
    return [UIColor colorWithRed:208/255.f green:208/255.f blue:208/255.f alpha:1.0];
}

+ (instancetype)wj_orange
{
    return [self colorWithHexString:@"#FF7900"];
}
+ (instancetype)wj_lightOrange
{
